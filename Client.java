...
public class Client implements ActionListener {
    ...
    Client(){
        ...
        p1.setBackground(new Color(70,70,70));
        ...
        Image i11 = i10.getImage().getScaledInstance(35,35, Image.SCALE_SMOOTH);
        ImageIcon i12 = new ImageIcon(i11);
        JLabel phone = new JLabel(i12);
        phone.setBounds(360, 20, 35, 32);
        p1.add(phone);

        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/3icon.png"));
        Image i14 = i13.getImage().getScaledInstance(35,35, Image.SCALE_SMOOTH);
        ImageIcon i15 = new ImageIcon(i14);
        JLabel morevert = new JLabel(i15);
        morevert.setBounds(420, 20, 10, 30);
        p1.add(morevert);

        JLabel name = new JLabel("Maggie");
        ...
        status.setBounds(110, 35, 100, 19);
